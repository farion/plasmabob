...
use io::{assets_dir, load_level, next_entity_id, save_level, scan_levels, LevelEntry};
use model::{normalize_asset_reference, EntityDefinition, EntityTypeDefinition, LevelBoundsDefinition, LevelFile};
...
fn level_picker_ui(
    ...
    egui::CentralPanel::default().show(ctx, |ui| {
        ...
        ui.label("Wähle ein Level aus `assets/levels` aus.");
        ui.add_space(12.0);
