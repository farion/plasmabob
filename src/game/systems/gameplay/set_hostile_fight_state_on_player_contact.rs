...
use crate::game::components::animation::{
    AnimationState, EntityState, HitStateTimer, MELEE_ATTACK_STATE_SECONDS, MeleeAttackStateTimer,
    can_set_state,
};
...
pub(crate) fn set_hostile_fight_state_on_player_contact(
    ...
    for (hostile_entity, colliding_entities, mut hostile_state, hit_timer, fight_timer, health) in
        &mut hostiles
    {
