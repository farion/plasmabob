...
use crate::game::view_api::{LevelQuotes, GameViewEntity};
...
pub(crate) fn play_hostile_death_quotes(
    ...
    cooldown: Option<ResMut<crate::game::view_api::QuoteCooldown>>,
    dead_hostiles: Query<(Entity, &Health), (With<Hostile>, With<Npc>, With<SpawnedLevelEntity>, Without<crate::game::systems::combat_types::DeathQuotePlayed>)>,
) {
    ...
    for (entity, health) in &dead_hostiles {
        ...
        commands.entity(entity).insert(crate::game::systems::combat_types::DeathQuotePlayed);
