...
pub(crate) fn update_level_hud(
    ...
    mut kills_query: Query<&mut Text, (With<crate::game::systems::hud_types::LevelKillsText>, Without<crate::game::systems::hud_types::LevelTimeText>, Without<crate::game::systems::hud_types::PlayerHealthPercentText>, Without<crate::game::systems::hud_types::PlayerPlasmaCooldownPercentText>)>,
) {
