...
use crate::game::components::animation::{AnimationPlayback, EntityState, PreloadedAnimations};
...
pub fn animation_frames_for_state<'a>(
...
pub fn animation_frame_duration_for_state(frame_durations: &AnimationFrameDurations, state: EntityState) -> f32 {
    frame_durations
        .0
        .get(state.animation_key())
        .copied()
